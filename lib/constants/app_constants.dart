class AppConstants {
  ...
  static const List<String> MATES_AFFILIATION_LIST = [
    "Student",
    "Alumni",
    "Faculty",
  ...
  static const Map<String, List<String>> STATES_CITIES_MAP = {
    "Maharashtra": [
      "Achalpur",
      "Ahmednagar",
      "Akola",
    ...
    "Himachal Pradesh": ["Mandi", "Nahan", "Shimla", "Solan", "Sundarnagar"],
